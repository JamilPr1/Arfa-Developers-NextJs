/**
 * Official MUI Marketing Page / Dashboard shared-theme primitives
 * Source: https://github.com/mui/material-ui/.../templates/shared-theme/themePrimitives.ts
 * Adapted for @mui/material v5 (no cssVariables / colorSchemes APIs).
 */
...
type Shadows = typeof defaultTheme.shadows
...
/** Hex aliases for places that still need string replaces (admin, CSS). */
export const brandHex = {
  primary: '#0A7CFF', // ≈ brand[400]
  primaryDark: '#0059B2', // ≈ brand[700]
  primaryDeep: '#002B5C', // ≈ brand[800]
  gray900: '#0B0E14',
  gray800: '#0C111B',
  canvas: '#FCFCFD',
  paper: '#F2F4F8',
...
export function getDesignTokens(mode: PaletteMode = 'light') {
  ...
  return {
    palette: {
      ...
      text: {
        // Keep body copy high-contrast on light/dark surfaces (avoid dull/washed text)
        primary: mode === 'dark' ? 'hsl(0, 0%, 100%)' : gray[800],
        secondary: mode === 'dark' ? gray[300] : gray[700],
      },
      action: {
